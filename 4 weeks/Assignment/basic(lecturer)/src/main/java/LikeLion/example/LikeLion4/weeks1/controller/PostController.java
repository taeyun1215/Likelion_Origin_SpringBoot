package LikeLion.example.LikeLion4.weeks1.controller;

import LikeLion.example.LikeLion4.weeks1.model.PostDto;
import LikeLion.example.LikeLion4.weeks1.repository.PostRepository;
...
public class PostController {
    ...
    public ResponseEntity<?> updatePost(@PathVariable("boardId") Long boardId, @PathVariable("postId") Long postId, @RequestBody PostDto dto) {
        // @RequestBody PostDto dto는 변경할 내용과 비밀번호를 입력하기 위함
    ...
    public ResponseEntity<?> deletePost(@PathVariable("boardId") Long boardId, @PathVariable("postId") Long postId, @RequestBody String password) {
