...
import dev.aquashdw.community.dto.ShopDto;
import dev.aquashdw.community.dto.ShopPostDto;
import dev.aquashdw.community.dto.ShopReviewDto;
...
public class ShopService {
    ...
    public ShopPostDto readShopPost(Long shopId, Long postId) {
        ...
        if (!shopPostEntity.getShop().getId().equals(shopId))   // 중요함
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST);
